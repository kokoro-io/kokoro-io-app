...
- [ ] メッセージ一覧の表示更新時もしくはスクロール時に各メッセージが表示されているかどうかを判定する
- [ ] `message_created`またはプッシュ通知を受信した場合、
...
- [ ] 未取得IDが追加された場合、現在閲覧中のチャンネルでなければOS固有の「トースト」を表示する
- [ ] メッセージが表示された場合、「トースト」を破棄する処理を行う
- [ ] 画面上のチャンネルの未読件数としては「未閲覧の取得メッセージ数」と「未取得ID数」を加算した値を表示する