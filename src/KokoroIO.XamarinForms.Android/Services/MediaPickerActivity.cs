...
// ***********************************************************************
// 
// 2017-11-09 Support content url scheme.
            ...
            bool isPhoto, ref Uri path, Uri data)
        {
            ...
            if (action != Intent.ActionPick)
            {
                ...
                if (data != null && data.Path != originalPath)
                {
                    ...
                    pathFuture = Task.FromResult(new Tuple<string, bool>(path.Path, false));
            }
            else if (data != null)
            {
                originalPath = data.ToString();
            ...
            {
                pathFuture = Task.FromResult<Tuple<string, bool>>(null);
            }
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (contentPath == null || !contentPath.StartsWith("file"))
                            {
                                ...
                                try
                                {
                                    var file = new System.IO.FileInfo(outputPath.Path);
